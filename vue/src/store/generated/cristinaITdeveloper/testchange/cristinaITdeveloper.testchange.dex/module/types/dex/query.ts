...
export class QueryClientImpl implements Query {
  ...
  SellOrderBook(request: QueryGetSellOrderBookRequest): Promise<QueryGetSellOrderBookResponse> {
    ...
    const promise = this.rpc.request('cristinaITdeveloper.testchange.dex.Query', 'SellOrderBook', data)
  ...
  SellOrderBookAll(request: QueryAllSellOrderBookRequest): Promise<QueryAllSellOrderBookResponse> {
    ...
    const promise = this.rpc.request('cristinaITdeveloper.testchange.dex.Query', 'SellOrderBookAll', data)
  ...
  BuyOrderBook(request: QueryGetBuyOrderBookRequest): Promise<QueryGetBuyOrderBookResponse> {
    ...
    const promise = this.rpc.request('cristinaITdeveloper.testchange.dex.Query', 'BuyOrderBook', data)
  ...
  BuyOrderBookAll(request: QueryAllBuyOrderBookRequest): Promise<QueryAllBuyOrderBookResponse> {
    ...
    const promise = this.rpc.request('cristinaITdeveloper.testchange.dex.Query', 'BuyOrderBookAll', data)
  ...
  DenomTrace(request: QueryGetDenomTraceRequest): Promise<QueryGetDenomTraceResponse> {
    ...
    const promise = this.rpc.request('cristinaITdeveloper.testchange.dex.Query', 'DenomTrace', data)
  ...
  DenomTraceAll(request: QueryAllDenomTraceRequest): Promise<QueryAllDenomTraceResponse> {
    ...
    const promise = this.rpc.request('cristinaITdeveloper.testchange.dex.Query', 'DenomTraceAll', data)
