...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/cristinaITdeveloper/testchange/dex/buyOrderBook
   */
  queryBuyOrderBookAll = (
    ...
    this.request<DexQueryAllBuyOrderBookResponse, RpcStatus>({
      path: `/cristinaITdeveloper/testchange/dex/buyOrderBook`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/cristinaITdeveloper/testchange/dex/buyOrderBook/{index}
   */
  queryBuyOrderBook = (index: string, params: RequestParams = {}) =>
    this.request<DexQueryGetBuyOrderBookResponse, RpcStatus>({
      path: `/cristinaITdeveloper/testchange/dex/buyOrderBook/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/cristinaITdeveloper/testchange/dex/denomTrace
   */
  queryDenomTraceAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<DexQueryAllDenomTraceResponse, RpcStatus>({
      path: `/cristinaITdeveloper/testchange/dex/denomTrace`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/cristinaITdeveloper/testchange/dex/denomTrace/{index}
   */
  queryDenomTrace = (index: string, params: RequestParams = {}) =>
    this.request<DexQueryGetDenomTraceResponse, RpcStatus>({
      path: `/cristinaITdeveloper/testchange/dex/denomTrace/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/cristinaITdeveloper/testchange/dex/sellOrderBook
   */
  querySellOrderBookAll = (
    ...
    this.request<DexQueryAllSellOrderBookResponse, RpcStatus>({
      path: `/cristinaITdeveloper/testchange/dex/sellOrderBook`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/cristinaITdeveloper/testchange/dex/sellOrderBook/{index}
   */
  querySellOrderBook = (index: string, params: RequestParams = {}) =>
    this.request<DexQueryGetSellOrderBookResponse, RpcStatus>({
      path: `/cristinaITdeveloper/testchange/dex/sellOrderBook/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
