...
export const protobufPackage = 'cristinaITdeveloper.testchange.dex'
...
const baseMsgSendCreatePair: object = { creator: '', port: '', channelID: '', timeoutTimestamp: 0, sourceDenom: '', targetDenom: '' }
...
const baseMsgSendSellOrder: object = { creator: '', port: '', channelID: '', timeoutTimestamp: 0, amountDenom: '', amount: 0, priceDenom: '', price: 0 }
...
export class MsgClientImpl implements Msg {
  ...
  SendCreatePair(request: MsgSendCreatePair): Promise<MsgSendCreatePairResponse> {
    ...
    const promise = this.rpc.request('cristinaITdeveloper.testchange.dex.Msg', 'SendCreatePair', data)
  ...
  SendSellOrder(request: MsgSendSellOrder): Promise<MsgSendSellOrderResponse> {
    ...
    const promise = this.rpc.request('cristinaITdeveloper.testchange.dex.Msg', 'SendSellOrder', data)
  ...
  CancelSellOrder(request: MsgCancelSellOrder): Promise<MsgCancelSellOrderResponse> {
    ...
    const promise = this.rpc.request('cristinaITdeveloper.testchange.dex.Msg', 'CancelSellOrder', data)
  ...
  CancelBuyOrder(request: MsgCancelBuyOrder): Promise<MsgCancelBuyOrderResponse> {
    ...
    const promise = this.rpc.request('cristinaITdeveloper.testchange.dex.Msg', 'CancelBuyOrder', data)
